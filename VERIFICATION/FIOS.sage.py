...
_sage_const_17 = Integer(17); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_3 = Integer(3); _sage_const_7 = Integer(7); _sage_const_6 = Integer(6)
import math
import random
...
def FIOS(a: int, b: int, p: int, w: int = _sage_const_17 , p_prime_0: Optional[int] = None) -> int:
    """
        Function: FIOS.
    ...
    for i in range(s):
        ...
        m = res_arr[_sage_const_0 ]*p_prime_0 % W
...
def FIOS_modexp(a: int, b: int, p: int, w: int = _sage_const_17 , p_prime_0: Optional[int] = None) -> int:
    """
    ...
    if (b == _sage_const_0 ):
        ...
        res = a
        for digit in bin(b)[_sage_const_3 :]:
...
if __name__ == "__main__":
    ...
    WIDTH_list = [_sage_const_2 **(_sage_const_7 +i) for i in range(_sage_const_6 )]
    WIDTH = random.choice(WIDTH_list)

    p = random_prime(_sage_const_2 **WIDTH, False, _sage_const_2 **(WIDTH-_sage_const_1 ))
    
    a = random.randrange(_sage_const_2 **(WIDTH-_sage_const_1 ), p)
    b = random.randrange(_sage_const_2 **(WIDTH-_sage_const_1 ), p)

    w = _sage_const_17  
    W = _sage_const_2 **w
    
    s = ((WIDTH+_sage_const_1 )-_sage_const_1 )//w + _sage_const_1 

    R = _sage_const_2 **(s*w)
    R2_mod = R**_sage_const_2  % p
    ...
    res = FIOS(res_mgt, _sage_const_1 , p, w = w, p_prime_0 = p_prime_0)
